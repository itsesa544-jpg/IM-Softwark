                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    <div className="lg:w-1/3">
                        <div className="relative w-64 h-64 mx-auto">
                            <div className="absolute inset-0 bg-cyan-500 rounded-full blur-2xl opacity-60"></div>
                            <img 
                                src="https://res.cloudinary.com/dlklqihg6/image/upload/v1760308052/kkchmpjdp9izcjfvvo4k.jpg" 
                                alt="Mohammad Esa Ali"
                                className="relative w-64 h-64 rounded-full object-cover border-4 border-gray-600 shadow-xl"
                            />
                        </div>
                    </div>
                    <div className="lg:w-2/3 text-center lg:text-left">
                        ...
                        <blockquote className="border-l-4 border-cyan-500 pl-4 py-2 bg-gray-800 rounded-r-lg">
                            <p className="text-xl italic text-cyan-300">
